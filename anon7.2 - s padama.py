...
def infer_first_name_nominative(obs: str) -> str:
    ...
    debug_names = ['artur', 'viktor', 'albert', 'alberta', 'alice', 'alica', 'max', 'maxa', 'albín', 'albíně', 'elen', 'elena', 'eleně', 'jana', 'jan', 'petr', 'petra', 'martin', 'martina', 'michael', 'michaela', 'alen', 'alena']
