...
def create_license(
    ...
    # Normalizuj HW ID (odstraň pomlčky, uppercase)
    hw_id_clean = hw_id.replace('-', '').replace(' ', '').upper()
    ...
    sign_string = f"{license_key}|{hw_id_clean}|{expiry_date.isoformat()}|{license_type}"
...
def interactive_generator():
    ...
    print("\n" + "=" * 70)
    print("SKRYI LICENSE GENERATOR - Production")
    print("=" * 70)
    print()
